...
$sql="Select *from tblcollegepost WHERE city='$City' AND faculty='$faculty'";
...
<a href="listings-single.php?id=<?php echo $row['id']; ?>"class="img d-block" style="background-image: url('admin/image/<?php echo $row['image'];?>')"></a>
